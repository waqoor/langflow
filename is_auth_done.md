...
| TEST-03 | Exactly eight enabled real-user journeys, one worker, zero retries | P §20.5 | DONE | Final candidate 60ec395cac: J1–J8 each passed once, zero skipped/flaky/unexpected cases and retry 0, verified from JSON. | E2E; run 34774822659; jobs 103771288935/103776825216; current verification ledger | Functional journey proof, not excluded secret/history coverage. |
| TEST-04 | Current-commit SQLite/PostgreSQL 16 × Python 3.10/3.14 acceptance | P §§20–23 | DONE | Final candidate 60ec395cac: all four configurations pass 496 cases each, with zero failed/skipped/deselected cases or retries. | run 34774822659; jobs 103771045237/103771045240/103771045243/103771045247; current verification ledger | Real database, migration, transaction, lifecycle and API coverage retained, including ten new empty-PATCH cases. |
| TEST-05 | Current combined backend, LFX, frontend, build, container and docs checks | P §§20–23 | DONE | Final candidate 60ec395cac passes combined CI: 41 successes, eight conditional skips. All ten general backend groups, LFX, Jest, core, ARM64 and required authz jobs pass. Full core separately passes 179 tests with 12 existing skips. | runs 34774822659/34774824410; CI Success 103777051374; current verification ledger | Unchanged docs checks retain merge evidence; skips are not new passes. No introduced TypeScript diagnostics; existing typing limits remain. |
| TEST-06 | Current affected accessibility evidence and explicit manual limits | P §20.8 | DONE | Final candidate passes eight journeys and nine IBM scans: zero confirmed/ignored violations, 13,925 passing results, 184 potential violations, four potential recommendations and nine manual results. | run 34774822659 job 103771288935; current verification ledger; historical merge accessibility unit run 34769869813 (101 suites/447 tests) | Potential/manual findings and native assistive-technology limits remain explicit. Historical unit evidence is not relabeled as a new run. |
